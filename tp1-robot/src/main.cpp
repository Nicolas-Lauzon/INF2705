...
void FenetreTP::clavier( TP_touche touche )
{
    ...
    case TP_f: // Diminuer la taille du corps
        ...
        std::cout << " bonhomme->taille=" << bonhomme->taille << " bonhomme->angleCorps=" << bonhomme->angleCorps << " bonhomme->angleAile=" << bonhomme->angleAile << " bonhomme->angleBras=" << bonhomme->angleBras << std::endl;
        break;
    case TP_DEBUT:
